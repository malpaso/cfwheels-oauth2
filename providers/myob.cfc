component extends="oauth2" accessors="true" {
	...
	/**
	* I return an initialized myob object instance.
	...
	**/
	public myob function init(
		required string client_id, 
		required string client_secret, 
		required string authEndpoint = 'https://secure.myob.com/oauth2/account/authorize', 
		required string accessTokenEndpoint = 'https://secure.myob.com/oauth2/v1/authorize',
